...
namespace ReportesVentas.Helper
{
    public sealed class AccesoBD
    {
        ...
        private readonly string cadena_conexion = "Provider=SQLNCLI11;workstation id=bicicleteria.mssql.somee.com; packet size=4096;user id=milizc_SQLLogin_1;pwd=2s9o1yeexo;data source=bicicleteria.mssql.somee.com;persist security info=False;initial catalog=bicicleteria";
